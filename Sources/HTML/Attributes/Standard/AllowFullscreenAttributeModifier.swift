...
public protocol AllowFullscreenAttributeModifier {
    associatedtype AllowFullscreenAttributeValueType: AttributeValueRepresentable = String
}
...
extension AllowFullscreenAttributeModifier where Self: Attributes & Mutable {
    ...
    public func allowFullscreen(
        ...
        setAttribute(key: StandardAttributeKey.allowfullscreen, value: value?.attributeValue)
    }
}
