...
public protocol OnLoadedDataAttributeModifier {
    associatedtype OnLoadedDataAttributeValueType: AttributeValueRepresentable = String
}
...
extension OnLoadedDataAttributeModifier where Self: Attributes & Mutable {
    ...
    public func onLoadedData(
        ...
        setAttribute(key: EventAttributeKey.onloadeddata, value: value?.attributeValue)
    }
}
