...
public protocol OnMouseOverAttributeModifier {
    associatedtype OnMouseOverAttributeValueType: AttributeValueRepresentable = String
}
...
extension OnMouseOverAttributeModifier where Self: Attributes & Mutable {
    ...
    public func onMouseOver(
        ...
        setAttribute(key: EventAttributeKey.mouseOver, value: value?.attributeValue)
    }
}
