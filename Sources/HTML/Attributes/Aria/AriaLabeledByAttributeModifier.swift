...
public protocol AriaLabeledByAttributeModifier {
    associatedtype AriaLabeledByAttributeValueType: AttributeValueRepresentable = String
}
...
extension AriaLabeledByAttributeModifier where Self: Attributes & Mutable {
    ...
    public func ariaLabeledBy(
        ...
        setAttribute(key: AriaAttributeKey.labeledBy, value: value?.attributeValue)
    }
}
