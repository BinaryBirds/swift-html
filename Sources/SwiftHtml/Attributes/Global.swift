...
extension String {
    ...
    fileprivate var classArray: [String] {
...
extension Array where Element == String {
    ...
    fileprivate var classString: String {
...
extension Tag {
    ...
    ///
    public func `class`(add value: String?, _ condition: Bool = true) -> Self {
    ...
    ///
    public func `class`(add values: [String], _ condition: Bool = true) -> Self
    {
    ...
    public func `class`(remove value: String?, _ condition: Bool = true) -> Self
    {
        guard let value = value else {
            return self
        }
    ...
    public func `class`(remove values: [String], _ condition: Bool = true)
        -> Self
    {
    ...
    public func `class`(toggle value: String?, _ condition: Bool = true) -> Self
    {
        guard let value = value else {
            return self
        }
