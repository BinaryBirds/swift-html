...
public extension Input {
    ...
    func accept(_ value: String) -> Self {
        node.addOrReplace(Attribute(key: "accept", value: value))
        return self
    }
    ...
    func checked(_ value: Bool = true) -> Self {
        guard value else {
            node.remove(Attribute(key: "checked"))
            return self
        }
        node.addOrReplace(Attribute(key: "checked"))
        return self
    }
    ...
    func formtarget(_ value: TargetFrame) -> Self {
        node.addOrReplace(Attribute(key: "formtarget", value: value.rawValue))
        return self
    }
    ...
    func list(_ value: String) -> Self {
        node.addOrReplace(Attribute(key: "list", value: value))
        return self
    }
    ...
    func min(_ value: String) -> Self {
        node.addOrReplace(Attribute(key: "min", value: value))
        return self
    }
    
    /// Specifies the minimum number of characters required in an `<input>` element
    func minlength(_ value: Int) -> Self {
        node.addOrReplace(Attribute(key: "minlength", value: String(value)))
        return self
    }
    ...
    func pattern(_ value: String) -> Self {
        node.addOrReplace(Attribute(key: "pattern", value: value))
        return self
    }
    ...
    func step(_ value: Int) -> Self {
        node.addOrReplace(Attribute(key: "step", value: String(value)))
        return self
    }
